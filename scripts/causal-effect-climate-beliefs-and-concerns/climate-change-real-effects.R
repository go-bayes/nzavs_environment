...
X = "Env.ClimateChgReal_lead1_z"



#hist(data_long$Env.ClimateChgReal_lead1_z)
# sd(data_long$Env.ClimateChgReal_lead1_z)
# min(data_long$Env.ClimateChgConcern_lead1_z)
# max(data_long$Env.ClimateChgConcern_lead1_z)
...
h_tab |>
  kbl(caption = main,
      ...
      "html") |>
  kable_styling() %>%
  row_spec(c(1:8),  # Bold out the lines where EVALUES do not cross zero or for ratios, 1
           bold = T,
           # color = "black",
           background = "bold") |>
  kable_minimal(full_width = F)
...
h_tab |>
  kbl(caption = main,
      ...
      "html") |>
  #kable_styling() %>%
  row_spec(c(1,2,4),  # Bold out the lines where EVALUES do not cross zero or for ratios, 1
           bold = T,
           # color = "black",
           background = "bold") |>
  kable_minimal(full_width = F)
...
reflective_plots <- #satnzenv3_p +
  ...
  sacrificemade4_p +
  sacrificenorms4_p +
  plot_annotation(title = "Causal effects of belief in reality of climate change on stated environmental values") +
...
ggsave(
  reflective_plots,
  path = here::here(here::here("figs", "figs_environ_real", "reflective_plots")),
  width = 16,
  height = 12,
  units = "in",
...
revealed_plots <- carbon1_p +
  ...
  motorway5_p +
  publictransport5_p +
  plot_annotation(title = "Causal effects of belief in reality of climate change on revealed environmental values") +
  plot_layout(guides = 'collect')
...
ggsave(
  revealed_plots,
  path = here::here(here::here("figs", "figs_environ_real", "revealed_plots")),
  width = 16,
  height = 12,
  units = "in",
