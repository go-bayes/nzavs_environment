...
## We investigate the following beliefs

  1. Climate change: (a) is real (b) is human caused
  
  2. Climate concern
  
  3. Beliefs that my behaviour can make protect the environment
...
- More analyses at: https://github.com/jacopastorius/nzavs_environment
</div>
...
-  Those who become more conservativism are expected to present relatively *lower environmental beliefs, concerns, and behaviors*, whereas those who become less conservative are expected to present relatively *greater environmental beliefs, concerns, and behaviors*.

-  Those who become more religiously identified are expected to present relatively *greater environmental beliefs, concerns, and behaviors*. whereas those who become less religiously identified are expected to *lower environmental beliefs, concerns, and behaviors* 

-  Beware of ecological fallacies! Between-person change is *not* the same as within-person change!

-  Question for my fellow IRPSIANS: what are some hypotheses to explain why increasing religious identification should be associated with greater environmental awareness/behavior? 
...
- Chris G Sibley, University of Auckland for leading the NZAVS. 

- The 40 - 60 NZAVS collaborators working to keep the study going, including *Donnie Davis* (virtue project co-leader), Daryl Van Tongeren & Ev Worthington (collaborators).

- Templeton Religion Trust Grant 0196 for their financial support

- *You* for your attention and interest

- comments/interest to joseph.bulbulia@vuw.ac.nz  (more analyses at: https://github.com/jacopastorius/nzavs_environment)
